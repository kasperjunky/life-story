// Version 1.2 - Removing Progress Bar & Improving Insights Fetch Timing
...
downloadButton.addEventListener("click", () => {
    ...
    const lines = doc.splitTextToSize(pdfContent, 180); // ✅ Prevents text cutoff
...
adviceButton.addEventListener("click", async () => {
    ...
    adviceButton.style.display = "none"; // ✅ Hide button after fetching advice
});
