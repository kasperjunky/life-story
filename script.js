...
async function showResults() {
  ...
  setTimeout(async () => {
    ...
    if (rewriteInsights?.encouragingRewrite) {
      ...
      // Remove unwanted prefixes such as "Reframed positively," or "Rewritten Life Story:" and fix pronouns
      rewriteText = rewriteText.replace(/^(Reframed\s+positively,\s*|Rewritten\s+Life\s+Story:\s*)/i, "")
