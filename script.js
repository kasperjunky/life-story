// Version 1.7 - Improved ChatGPT Insights Formatting
    ...
    try {
        ...
        const response = await fetch("https://interactive-backend.onrender.com/api/generate", {
            ...
            body: JSON.stringify({ 
                ...
                includeAdvice,
                prompts: {
                    storySummary: "Analyze the user's responses and generate a narrative summary about their life. Start with: 'Based on your answers, it seems that you had a...' and provide a reflective, engaging insight. Avoid judgmental or overly optimistic wording.",
