// Version 4.7 Final – Now using GPT-3.5-Turbo-0125 & Ensuring Question Load
...
async function getInsightsFromChatGPT(answers, includeAdvice, insightType) {
  try {
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        model: "gpt-3.5-turbo-0125",  // Now using GPT-3.5-Turbo-0125
        messages: [
    ...
    console.log(`✅ ${insightType} insights received:`, data);  // Debugging log
