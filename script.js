...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (encouragingRewriteHeading) {
    encouragingRewriteHeading.textContent =
      currentLanguage === "en"
        ? "Let's look at your life story in a kind, empowering way—like one of your most beloved friends would see it."
        : "בוא נסתכל על סיפור חייך בצורה אוהבת ומעצימה—כמו שחבר קרוב היה רואה אותו.";
  }
});
