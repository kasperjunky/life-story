// Version 1 - Adding Insight Progress Animation
...
async function showResults() {
  ...
  insightLoader.style.display = "block"; // Show loading animation
  ...
  try {
    ...
    insightLoader.style.display = "none"; // Hide loading animation
...
const loaderHTML = '<div id="insight-loader" style="display: none; text-align: center; margin-top: 20px;">' +
                   '<div class="spinner"></div>' +
                   '<p>Generating insights, please wait...</p>' +
                   '</div>';
resultContainer.insertAdjacentHTML("afterbegin", loaderHTML);
