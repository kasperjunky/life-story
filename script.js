// Version 2.6 - Fixing "Download as PDF" Functionality
...
const downloadButton = document.getElementById("download-pdf"); // ✅ Fixing download functionality
...
downloadButton.style.display = "none"; // ✅ Ensure hidden at the start
...
async function showResults() {
    ...
    setTimeout(async () => {
        ...
        // ✅ Show "Download as PDF" after Encouraging Rewrite is displayed
        setTimeout(() => {
...
// 🟢 SECTION 7: Generate & Download PDF
downloadButton.addEventListener("click", () => {
    const doc = new window.jspdf.jsPDF(); // ✅ FIX: Correctly initialize jsPDF
