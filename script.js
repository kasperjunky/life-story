...
function displayQuestion() {
    ...
    if (!questions || !questions[currentLanguage]) {
        console.error("❌ Error: Questions are missing or not loaded correctly.");
        return;
    }
...
async function showResults() {
    ...
    // Show Download PDF only after second insight appears
    if (insights.encouragingRewrite && insights.encouragingRewrite.trim() !== "") {
